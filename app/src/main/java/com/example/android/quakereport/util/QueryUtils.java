...
*/
     ...
     */
    public static URL makeURL(String url_str)
    {
        URL url= null;
        try {
            url = new URL(url_str);
    ...
    public static String makeHttpRequest(String  url_str) throws IOException
    {
        Log.d("HEE","IN HTTPR");
        HttpURLConnection connection = null;
        String jsonResponse="";
        InputStream ins=null;
        URL url = makeURL(url_str);
        try
        {
            ...
            if(connection.getResponseCode()==200)
            {
                ...
                jsonResponse = getSampleJsonResponse(ins);
            }
            else
            {
